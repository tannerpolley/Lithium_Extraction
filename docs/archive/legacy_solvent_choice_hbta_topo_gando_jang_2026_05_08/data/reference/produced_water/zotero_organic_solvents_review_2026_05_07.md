...
|---:|---|---|---|---|
| 1 | HBTA/TOPO/sulfonated kerosene | Highest for the current objective: actual oil-and-gas field water, conventional extractant/synergist, direct stage/process evidence | Missing pure-component, Li-complex, binary-interaction, and reaction-equilibrium payloads | Keep as flagship; use the current source-regressed Li/Na stage model after divalent pretreatment until full organic-phase parameters are fitted |
