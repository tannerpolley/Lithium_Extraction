...
def candidates() -> list[Candidate]:
    return [
        ...
        Candidate(
            ...
            "DQ2M7ZG8",
            "literature_comparison_after_pretreatment",
            "cation exchanger plus lithium-selective neutral ligand",
            "synthetic geothermal brine comparison; outside active Li/Na-after-pretreatment objective",
            17,
            20,
            14,
            6,
            16,
            "Literature comparison only; not an active divalent-equilibrium target.",
