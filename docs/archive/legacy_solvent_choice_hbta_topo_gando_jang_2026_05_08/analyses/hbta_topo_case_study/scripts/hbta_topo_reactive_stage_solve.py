...
PARAM_DIR = REPO_ROOT / "data" / "reference" / "extraction_models" / "gando_2025"
...
def _write_predictive_audit() -> None:
    rows = [
        ...
        },
        {
            ...
            "evidence": "Ca/Mg/Ba are handled as pretreatment/feed-context species per Shan/Gando; Li/Na closure is the active target.",
        },
        {
...
def write_fit_artifacts(fit: ReactiveFit) -> None:
    ...
    payload = {
        ...
        "boundary": (
            ...
            "inside that Li/Na staged-transfer scope after divalent pretreatment, but it is not a full organic-phase "
            "ePC-SAFT LLE model because HBTA, TOPO, diluent, and Li-complex ePC-SAFT parameters are still unresolved."
        ),
    }
