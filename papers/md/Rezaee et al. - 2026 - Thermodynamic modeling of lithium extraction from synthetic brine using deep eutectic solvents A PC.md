...
Mehran Rezaee ${ }^{\mathrm{a}}$ (D), Farzaneh Feyzi ${ }^{\mathrm{a}, *{ }^{(B)} \text {, Rohaldin Miri }{ }^{\mathrm{b}}}$<br>${ }^{\mathrm{a}}$ Thermodynamics Research Laboratory, School of Chemical, Petroleum and Gas Engineering, Iran University of Science and Technology, Tehran 16846-13114, Iran<br>${ }^{\mathrm{b}}$ School of Chemical, Petroleum and Gas Engineering, Iran University of Science and Technology, Tehran 16765-163, Iran
...
![](https://cdn.mathpix.com/cropped/93f7cf5c-3cc6-42a8-8ff1-401396fd69cc-03.jpg?height=574&width=1435&top_left_y=187&top_left_x=316)
Fig. 1. Schematic of the equilibrium system.
...
| Component | $\Delta G_{f}^{0}\left(\frac{\mathrm{~kJ}}{\mathrm{~mol}}\right)$ | Reference |
| :--- | :--- | :--- |
| $\mathrm{H}_{2} \mathrm{O}$ | -237.13 | [30] |
| $\mathrm{Li}^{+}$ | -292.59 | [30,31] |
| $\mathrm{Na}^{+}$ | -261.88 | [30,31] |
| $\mathrm{OH}^{-}$ | -157.28 | [30,31] |
| TBAC | 77.93 | This work |
| DA | -310.59 | This work |
| DES | -543.25 | This work |
| RLi | -707.58 | This work |
| RNa | -657.13 | This work |
...
|  | $\Delta G^{0}\left(\frac{\mathrm{~kJ}}{\mathrm{~mol}}\right)$ | $K$ |
| :--- | :--- | :--- |
| Reaction A | 48.41 | $3.2983 \times 10^{-9}$ |
...
![](https://cdn.mathpix.com/cropped/93f7cf5c-3cc6-42a8-8ff1-401396fd69cc-04.jpg?height=840&width=1133&top_left_y=1688&top_left_x=465)
Fig. 2. Density of DES as a function of temperature, this work and from [25,36]. The data in this work have $\pm 0.1 \mathrm{~kg} / \mathrm{m}^{3}$ uncertainty in measurement.

Table 3
Parameters of Tait correlation of the DES.
| Parameter | Value | Unit |
| :--- | :--- | :--- |
| $A_{0}$ | 1172.12 | $\frac{\mathrm{kg}}{\mathrm{m}^{3}}$ |
| $A_{1}$ | -1.5749 | $\frac{\mathrm{kg}}{\mathrm{m}^{3} \mathrm{~K}}$ |
| $A_{2}$ | 0.000404 | $\frac{\mathrm{kg}}{\mathrm{m}^{3} \mathrm{~K}^{2}}$ |
| $A_{3}$ | $-5.5079 \times 10^{-6}$ | $\frac{\mathrm{kg}}{\mathrm{m}^{3} \mathrm{~K}^{3}}$ |
...
| $\sigma$ | 3.1570 | Å |
| $u / k$ | 305.09 | K |
| Number of association sites | 2 | - |
| $\kappa^{A_{i} B_{j}}$ | 0.15 | - |
| $\varepsilon^{A_{i} B_{j}} / k$ | 6900 | K |
...
| Parameter | Value | Unit |
| :--- | :--- | :--- |
| $A_{0}$ | 890.42 | $\frac{\mathrm{kg}}{\mathrm{m}^{3}}$ |
| $A_{1}$ | 1.3138 | $\frac{\mathrm{kg}}{\mathrm{m}^{3} \mathrm{~K}}$ |
| $A_{2}$ | -0.006050 | $\frac{\mathrm{kg}}{\mathrm{m}^{3} \mathrm{~K}^{2}}$ |
| $A_{3}$ | $6.0606 \times 10^{-6}$ | $\frac{\mathrm{kg}}{\mathrm{m}^{3} \mathrm{~K}^{3}}$ |
...
| $\sigma$ | 3.7550 | Å |
| $u / k$ | 395.55 | K |
| Number of association sites | 1 | - |
| $\kappa^{A_{i} B_{j}}$ | 0.01 | - |
| $\varepsilon^{A_{i} B_{j}} / k$ | 1520 | K |
...
### 3.2. Reaction equilibrium calculation
...
![](https://cdn.mathpix.com/cropped/93f7cf5c-3cc6-42a8-8ff1-401396fd69cc-05.jpg?height=843&width=1133&top_left_y=1683&top_left_x=467)
Fig. 3. Comparison of the calculated density and experimental data for DES.

![](https://cdn.mathpix.com/cropped/93f7cf5c-3cc6-42a8-8ff1-401396fd69cc-06.jpg?height=837&width=1133&top_left_y=193&top_left_x=467)
Fig. 4. Experimental and calculated density of $10 \%$ TOPO solution in DES. The data in this work have $\pm 0.1 \mathrm{~kg} / \mathrm{m}^{3}$ uncertainty in measurement.
...
![](https://cdn.mathpix.com/cropped/93f7cf5c-3cc6-42a8-8ff1-401396fd69cc-07.jpg?height=1715&width=889&top_left_y=191&top_left_x=589)
Fig. 5. Flowchart of fitting PC-SAFT parameters for RLi and RNa .

Table 8
PC-SAFT parameters for RLi and RNa.
| Parameter | RLi | RNa | Unit |
| :--- | :--- | :--- | :--- |
| $m$ | 11.1223 | 11.1504 | - |
| $\sigma$ | 3.8327 | 4.0254 | Å |
| $u / k$ | 392.09 | 427.44 | K |
| $\kappa^{A_{i} B_{j}}$ | 0 | 0 | - |
| $\varepsilon^{A_{i} B_{j}} / k$ | 0 | 0 | K |
...
![](https://cdn.mathpix.com/cropped/93f7cf5c-3cc6-42a8-8ff1-401396fd69cc-08.jpg?height=1814&width=886&top_left_y=191&top_left_x=592)
Fig. 6. Flowchart of equilibrium calculations.
...
![](https://cdn.mathpix.com/cropped/93f7cf5c-3cc6-42a8-8ff1-401396fd69cc-09.jpg?height=871&width=1147&top_left_y=185&top_left_x=460)
Fig. 7. Deviation of calculated extraction percentage from experimental data [17].

![](https://cdn.mathpix.com/cropped/93f7cf5c-3cc6-42a8-8ff1-401396fd69cc-09.jpg?height=882&width=1140&top_left_y=1177&top_left_x=465)
Fig. 8. Deviation of calculated selectivity from experimental data [17].
...
![](https://cdn.mathpix.com/cropped/93f7cf5c-3cc6-42a8-8ff1-401396fd69cc-10.jpg?height=1752&width=889&top_left_y=191&top_left_x=589)
Fig. 9. Flowchart for fitting $k_{i j}$ in organic phase.

Table 9
Binary interaction parameters of the PC-SAFT EOS in organic phase.
|  | DES | TOPO | RLi | RNa |
| :--- | :--- | :--- | :--- | :--- |
| DES | - | 0.0623 | 0.0104 | 0.0158 |
| TOPO | 0.0623 | - | 0.0115 | -0.0139 |
| RLi | 0.0104 | 0.0115 | - | -0.0127 |
| RNa | 0.0158 | -0.0139 | -0.0127 | - |
...
![](https://cdn.mathpix.com/cropped/93f7cf5c-3cc6-42a8-8ff1-401396fd69cc-11.jpg?height=864&width=1133&top_left_y=189&top_left_x=467)
Fig. 10. Deviation of calculated lithium extraction percentage from experimental data [17] using $k_{i j}$.

![](https://cdn.mathpix.com/cropped/93f7cf5c-3cc6-42a8-8ff1-401396fd69cc-11.jpg?height=882&width=1140&top_left_y=1179&top_left_x=465)
Fig. 11. Deviation of calculated selectivity from experimental data [17] using $k_{i j}$.
