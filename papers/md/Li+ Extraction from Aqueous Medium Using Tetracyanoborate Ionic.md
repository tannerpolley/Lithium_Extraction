...
[^0]![](https://cdn.mathpix.com/cropped/a59933d6-bca6-45db-b31f-2c9dd99cc78c-1.jpg?height=218&width=151&top_left_y=2342&top_left_x=1781)

Table 1. Characteristics of Chemicals Used in This Study
| component | abbreviation | $M / \mathrm{g} \mathrm{mol}^{-1}$ | CAS | supplier | purity ${ }^{a}$ /wt \% |
| :--- | :--- | :--- | :--- | :--- | :--- |
| 1-ethyl-3-methylimidazolium tetracyanoborate | [emim][tcb] | 226.05 | 742099-80-5 | Merck KgaA | >99.5 |
| 1-butyl-3-methylimidazolium tetracyanoborate | [bmim][tcb] | 282.16 | 742099-78-1 | Merck KgaA | >99.5 |
| 1-hexyl-3-methylimidazolium tetracyanoborate | [hmim][tcb] | 254.1 | 1240857-50-4 | Merck KGaA | >98 |
| tributyl phosphate | TBP | 266.32 | 126-73-8 | Merck KGaA | 97 |
| lithium chloride monohydrate | $\mathrm{LiCl} \cdot \mathrm{H}_{2} \mathrm{O}$ | 60.39 | 16712-20-2 | Alfa Aesar | 99.95 |
| water | $\mathrm{H}_{2} \mathrm{O}$ | 18.015 | 7732-18-5 | Milli-Q Integral System, Merck KGaA |  |
...
Table 2. Dielectric Constants for All Components Applied in This Work
| component | dielectric constant/C, $\mathrm{V} \mathrm{m}^{-1}$ | ref |
| :--- | :--- | :--- |
| water | -105.2 $\ln (T[\mathrm{~K}])+677.480$ | 29 |
| TBP | 11 | set to a constant number in this work |
| [emim] [tcb] | 11 | $a$ |
| $\mathrm{Li}^{+}$ | 8 | $b$ |
| $\mathrm{Mg}^{2+}$ | 8 | $b$ |
| $\mathrm{Cl}^{-}$ | 8 | $b$ |
...
Table 3. ePC-SAFT Pure-Component Parameters Used in This Work
| component | $m_{i}^{\text {seg }}$ | $\sigma_{i} / \AA$ | $\frac{u_{i}}{k_{\mathrm{b}}} / \mathrm{K}$ | $\frac{\epsilon^{A_{i} B_{i}}}{k_{\mathrm{b}}} / \mathrm{K}$ | $\kappa^{A B_{i}}$ | association scheme | ref |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| water | 1.2047 | $a$ | 353.95 | 2425.7 | 0.0451 | 2B | 35 |
| TBP | 10.796 | 3.2510 | 217.09 | 5000 | 0.01 | 2B | this work |
| [emim][tcb] | 7.1807 | 3.5680 | 338.10 | 5000 | 0.1 | 2B | this work |
| $\mathrm{Li}^{+}$ | 1 | $2.8449{ }^{b}$ | 360.00 | $0{ }^{c}$ | 1 | 2B | this work |
| $\mathrm{Mg}^{2+}$ | 1 | $3.1327{ }^{b}$ | 1500 |  |  |  | 34 |
| $\mathrm{Cl}^{-}$ | 1 | $2.7560{ }^{b}$ | 170.00 |  |  |  | 34 |
...
Table 4. Binary Interaction Parameters $\boldsymbol{k}_{\boldsymbol{i j}}$ Used in This Work
| parameters | $k_{i j}$ | $k_{i j}^{\mathrm{hb}}$ | refs |
| :--- | :--- | :--- | :--- |
| water-[emim][tcb] | -0.0175 | 0 | this work |
| $\mathrm{Li}^{+}$-TBP | -0.01 | -0.68 | this work |
| $\mathrm{Cl}^{-}$-TBP | -0.01 | n.a. | this work |
| water-TBP | -0.0475 | 0 | this work |
| $\mathrm{Li}^{+}$-water | 0 | $1{ }^{a}$ | this work |
| $\mathrm{Cl}^{-}$-water | 0 | n.a. | this work |
| $\mathrm{Li}^{+}-\mathrm{Cl}^{-}$ | 0.669 | n.a. | 34 |
| $\mathrm{Li}^{+}$-[emim][tcb] | -0.035 | $1{ }^{a}$ | this work |
| $\mathrm{Cl}^{-}-[\mathrm{emim}][\mathrm{tcb}]$ | -0.035 | n.a. | this work |
| $\mathrm{Li}^{+}-[\mathrm{bmim}][\mathrm{tcb}]$ | 0.12 | $1{ }^{a}$ | this work |
| $\mathrm{Cl}^{-}-[\mathrm{bmim}][\mathrm{tcb}]$ | 0.12 | n.a. | this work |
| $\mathrm{Li}^{+}-[\mathrm{hmim}][\mathrm{tcb}]$ | 0.15 | $1{ }^{a}$ | this work |
| $\mathrm{Cl}^{-}-[\mathrm{hmim}][\mathrm{tcb}]$ | 0.15 | n.a. | this work |
...
![](https://cdn.mathpix.com/cropped/a59933d6-bca6-45db-b31f-2c9dd99cc78c-5.jpg?height=631&width=839&top_left_y=369&top_left_x=1095)
Figure 2. Solubility of TBP in the organic phase at 1 bar and 294.15 K. Line: ePC-SAFT advanced using the parameters from Tables 2-4. Symbols: Exp. data according to Table S6. Standard uncertainty is $u(T)=0.5 \mathrm{~K} ; u(m)=0.0001 \mathrm{~g}$. The combined expanded uncertainty is $U=0.0363$, with a coverage factor of $k=2$ ( $95 \%$ confidence interval).
...
![](https://cdn.mathpix.com/cropped/a59933d6-bca6-45db-b31f-2c9dd99cc78c-6.jpg?height=590&width=746&top_left_y=204&top_left_x=221)
Figure 3. Effects of different ILs on experimental extraction efficiency $E_{\mathrm{Li}}{ }^{+}$with TBP and IL as the extractant $\left(w_{\mathrm{Li}^{+}}=2000 \mathrm{ppm}\right), R^{\mathrm{w}}\left(\frac{\mathrm{O}}{\mathrm{A}}\right)=1$ , $T=294.15 \mathrm{~K}, p=1.013$ bar, mixing time 2 h at 2500 rpm . Exp. data are given in Table S8. Standard uncertainty is $u(T)=0.5 \mathrm{~K} ; u(m)=$ 0.0001 g . The combined expanded uncertainty is $U=0.001$ with a coverage factor of $k=2$ ( $95 \%$ confidence interval).
...
![](https://cdn.mathpix.com/cropped/a59933d6-bca6-45db-b31f-2c9dd99cc78c-6.jpg?height=590&width=748&top_left_y=204&top_left_x=1136)
Figure 5. Effects of the TBP content in the organic phase on extraction efficiency $E_{\mathrm{Li}^{+}}$with [emim][tcb] and TBP ( $w_{\text {TBP, organic }}=$ 0.80 ) as the extractant ( $w_{\mathrm{Li}^{+}}=2000 \mathrm{ppm}$ ), $R^{\mathrm{w}}\left(\frac{\mathrm{O}}{\mathrm{A}}\right)=1, T=294.15 \mathrm{~K}$, $p=1.013$ bar, mixing time 2 h at 2500 rpm . Exp. data are given in Table S10. Standard uncertainty is $u(T)=0.5 \mathrm{~K} ; u(m)=0.0001 \mathrm{~g}$. The combined expanded uncertainty is $U=0.006$ with a coverage factor of $k=2$ ( $95 \%$ confidence interval).
...
![](https://cdn.mathpix.com/cropped/a59933d6-bca6-45db-b31f-2c9dd99cc78c-7.jpg?height=683&width=839&top_left_y=202&top_left_x=1095)
Figure 7. Effect of $R^{\mathrm{w}}(\mathrm{O} / \mathrm{A})$ on the extraction efficiency $E_{\mathrm{Li}^{+}}$with [emim][tcb] and TBP as the extractant ( $w_{\text {TBP, organic }}=0.85, w_{\mathrm{Li}}{ }^{+}=$ 2000 ppm ), $T=294.15 \mathrm{~K}, p=1.013$ bar, mixing time 2 h at 2500 rpm. Line: ePC-SAFT using the parameters from Tables 2-4. Symbols: Exp. data according to Table S11.
...
![](https://cdn.mathpix.com/cropped/a59933d6-bca6-45db-b31f-2c9dd99cc78c-9.jpg?height=1129&width=216&top_left_y=1503&top_left_x=1095)
