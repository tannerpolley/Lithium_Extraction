...
EXP_CSV = ANALYSIS_ROOT / "data" / "input" / "figure6_digitized_points.csv"
CALC_CSV = ANALYSIS_ROOT / "data" / "input" / "figure6_digitized_calc_curve.csv"
OUT_DIR = ANALYSIS_ROOT / "results" / "figure6"
